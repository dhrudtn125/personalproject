...
$(function(){
	$("#btnUpdate").click(function(){
		//폼 데이터 제출할 주소
		document.form1.action="/jsp03/member_servlet/update.do";
		document.form1.submit();
	});
	$("#btnDelete").click(function(){
		if(confirm("삭제하시겠습니까?")){
			document.form1.action="/jsp03/member_servlet/delete.do";
			document.form1.submit();
		}
	});
});
...
<form name="form1" method="post">
	<table>
		...
		<tr>
			<td>회원가입일자</td>
			<td><input name="join_date" value="<%= dto.getJoin_date()%>"></td>
		</tr>
		<tr>
